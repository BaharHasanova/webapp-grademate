                    ...
                    {studentData ? (
                        <div className="text-center p-6 rounded-lg shadow-lg">
                            <img
                                ...
                                alt="Avatar"
                            />
                            <h2 className="text-xl font-semibold break-words text-white">{studentData.full_name}</h2>
                            <p className="text-gray-300 break-words">{studentData.email}</p>
                            <p className="text-gray-300 break-words">{studentData.student_id}</p>
                            <p className="text-gray-300 break-words">{programName}</p>
                            <p className="text-gray-300 break-words">{semester}</p>
                            <p className="text-gray-300 break-words">CGPA: {studentData.cgpa || "Not Available"}</p>
                            <p className="text-gray-300 break-words">GPA: {studentData.gpa || "Not Available"}</p>
                            <p className="text-gray-300 break-words">Status: {studentData.status ? "Active" : "Inactive"}</p>
                            <button
